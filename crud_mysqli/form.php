                ...
                <form action="salvar.php" method="post">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="text" id="cpf" name="cpf" class="form-control" data-mask="000.000.000-00" minlength="14" required>
                                </div>
                                <div class="col">
                        ...
                        <div class="card-footer text-end">
                            <button type="button" class="btn btn-outline-danger"><i class="bi bi-arrow-left"> Voltar</i></button>
                            <button type="submit" class="btn btn-outline-primary"><i class="bi bi-floppy"> Salvar</i></button>
                        </div>
                    </div>
                </form>
            </div>
